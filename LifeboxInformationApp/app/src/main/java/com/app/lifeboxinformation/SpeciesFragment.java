...
public class SpeciesFragment extends Fragment {
    ...
    String htmlText = "<p>Inside the LifeBox you can find two species, and both species have a set of parameters that defines how they can evolve inside the virtual ecosystem. " +
